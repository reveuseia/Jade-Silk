...
public final class FragmentTransactionBinding implements ViewBinding {
  ...
  private FragmentTransactionBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView rvt) {
  ...
  public static FragmentTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rvt;
      RecyclerView rvt = ViewBindings.findChildViewById(rootView, id);
      if (rvt == null) {
        break missingId;
      }

      return new FragmentTransactionBinding((FrameLayout) rootView, rvt);
    }
