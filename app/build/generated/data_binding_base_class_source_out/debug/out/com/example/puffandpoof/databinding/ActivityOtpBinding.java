...
public final class ActivityOtpBinding implements ViewBinding {
  ...
  private ActivityOtpBinding(@NonNull LinearLayout rootView, @NonNull EditText otpEditText,
  ...
  public static ActivityOtpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.otpEditText;
      EditText otpEditText = ViewBindings.findChildViewById(rootView, id);
      if (otpEditText == null) {
        break missingId;
      }
      ...
      return new ActivityOtpBinding((LinearLayout) rootView, otpEditText, verifyButton);
    }
